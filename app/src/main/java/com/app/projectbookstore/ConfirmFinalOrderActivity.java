...
public class ConfirmFinalOrderActivity extends AppCompatActivity {
    ...
    private void Check()
    {
        ...
        if(TextUtils.isEmpty(fullName) || fullName.length() < 10){
            Toast.makeText(this,"Error! Please provide a valid contact person.",Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(contact) || contact.length() < 11)
        {
            Toast.makeText(this, "Error! Please provide a valid contact information.", Toast.LENGTH_SHORT).show();
        }
        else {
