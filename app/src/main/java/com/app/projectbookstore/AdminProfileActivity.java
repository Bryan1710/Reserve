...
public class AdminProfileActivity extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo() {
        ...
        Toast.makeText(AdminProfileActivity.this, "Profile Information was Updated Successfully.", Toast.LENGTH_SHORT).show();
        finish();
    }
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        startActivity(new Intent(AdminProfileActivity.this, AdminHomeScreenActivity.class));
                        Toast.makeText(AdminProfileActivity.this, "Profile Info was Updated Successfully.", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                    else{
                        progressDialog.dismiss();
